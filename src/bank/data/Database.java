	...
	private void initData() {
		try {
			...
			Client client1 = new Client("Ingrid", "Nunes", 1234567890, "123",
					new Date());
			CurrentAccount ca1 = new CurrentAccount(b1, 1l, client1, 30000000);
			save(ca1);
			Client client2 = new Client("Joao", "Silva", 1234567890, "123",
					new Date());
			CurrentAccount ca2 = new CurrentAccount(b2, 2l, client2, 2000000);
			save(ca2);
			Client client3 = new Client("Richer", "Rich", 1234567890, "123",
					new Date());
			CurrentAccount ca3 = new CurrentAccount(b2, 3l, client3, 100000000);
			save(ca3);
			...
			for (int i = 0; i < 8; i++) {
				...
				changeDate(ca1.transfer(atm2, ca2, 5001), r,cal);
